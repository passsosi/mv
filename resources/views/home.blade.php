      ...
      <div class="row row-cols-1 row-cols-sm-1 row-cols-md-2 g-3 mt-5">
        ...
        <div class="col">
          <div class="card shadow-sm">
              <img src="data:image/jpeg;base64,{{ base64_encode($el->image) }}" class="img-fluid w-100 card-img-top" style="max-width: 100%; min-height: auto; max-height: 400px; object-fit: cover;" alt="Image">
            <div class="card-body">
              <h2>{{$el->name}}</h2>
